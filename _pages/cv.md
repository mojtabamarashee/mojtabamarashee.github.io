...
<head>
    ...
    <meta name="csrf-token" content="C8Pvx4RdbgYTLGD7HKB65HYyWmEMvfY00TKfB6a3">
    ...
    <link rel="stylesheet" href="/css/desktop.3af130027c6a6ba75978d84d7b841d6d.css">
            <meta name="robots" content="noindex">
        <link rel="canonical" href="https://karboom.io/cv/rqxojk"/>
    
    
    <title>—“Ê„Â ¬‰·«Ì‰ mojtaba hoseini &#x007C; ò«—»Ê„  </title>
    <meta prefix="og: http://ogp.me/ns#" property="og:site_name" content="ò«—»Ê„ | —“Ê„Â ¬‰·«Ì‰"/>
    <meta prefix="og: http://ogp.me/ns#" property="og:title" content="mojtaba hoseini" />
    <meta prefix="og: http://ogp.me/ns#" property="og:type" content="website" />

    <meta prefix="og: http://ogp.me/ns#" property="og:image" content="    https://karboom.io/storage/
    "/>
    ...
    <meta prefix="og: http://ogp.me/ns#" property="og:image:alt" content="https://karboom.io/storage/"/>
            <meta prefix="og: http://ogp.me/ns#" property="og:url" content="https://karboom.io/cv/rqxojk/web" />
    ...
    <div class="row header-resume" id="header-resume">
        <div class="col-lg-4 col-md-4 p-l-0 ltr-pull-left ltr-p-l-15 ltr-p-r-0">
            ...
            <div class="col-lg-10 col-md-10 p-0 ltr-pull-left">
                <h2 class="ltr-text-left">—“Ê„Â «’·Ì</h2>
            </div>
        </div>
                ...
                <div class="box-resume-light clearfix">
                    <div class="col-lg-4 col-md-4 ltr-pull-left">
                        <div class="img-user left-auto right-0">
                                                            <img src="https://karboom.io/storage/" alt="" class="img-responsive">
                                                    </div>
                    </div>
                    <div class="col-lg-8 col-md-8 ltr-pull-left">
                                                    <h1 class="left-0">mojtaba hoseini</h1>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="resume-box-flex di-ltr">
                                        ...
                                        <h3 class="ltr-pull-left ltr-m-l-0 ltr-m-r-5">
                                                                                    ...
                                                                                    <h4 class="ltr-pull-left">„—œ</h4>
                                                                            </div>
                                                                                                    <div class="box ltr-pull-left ltr-p-l-0 ltr-p-r-50">
                                        <h3 class="ltr-pull-left ltr-m-l-0 ltr-m-r-5">
                                                                                            Ê÷⁄Ì  Œœ„ :
                                                                                    </h3>
                                                                                    <h4 class="ltr-pull-left">« „«„ Œœ„ </h4>
                                                                            </div>
                                                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-8 col-md-8 p-0 ltr-pull-left">
                            <div class="col-lg-12 col-md-12">
                                <div class="resume-box-flex di-ltr">
                                            ...
                                            <h4 class="ltr-pull-left">
                                                <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="4d202227392c2f2c202c3f2c3e2528280d2a202c2421632e2220">[email&#160;protected]</a>
                                            </h4>
                                        </div>
                                                                                                                <div class="box ltr-pull-left ltr-p-l-0 ltr-p-r-50">
                                            <i class="fa fa-map-marker ltr-pull-left ltr-m-r-10"></i>
                                                                                            <h4 class="ltr-pull-left"> Â—«‰ ŒÌ«»«‰ ÅÌ—Ê“Ì</h4>
                                                                                    </div>
                                                                    </div>
                            </div>
            ...
            <div id="educations">
                ...
                <div class="clearfix">
                    ...
                    <div class="clearfix">
                        ...
                        <div class="col-lg-7 col-md-7 border-right desc ltr-pull-left">
                            <div class="square"></div>
                                                            <h3 class="ltr-text-left">android app</h3>
                                                                                        <h4 class="ltr-text-left">»—‰«„Â ‰ÊÌ” java</h4>
                                                                                        <h6 class="ltr-text-left"> ÂÌÂ Ìò ÊÌÃ  «‰œ—ÊÌœÌ »—«Ì ‰„«Ì‘ ¬Œ—Ì‰ ﬁÌ„  ”òÂ Ê »Â —Ê“—”«‰Ì œ— Â— œﬁÌﬁÂ »œÊ‰ «” ›«œÂ «“ API</h6>
                                                    </div>
                    </div>
                    ...
                    <div class="clearfix">
                        ...
                        <div class="col-lg-7 col-md-7 border-right desc ltr-pull-left">
                            <div class="square"></div>
                                                            <h3 class="ltr-text-left">·«ê— ‰„«Ì‘ œÌ «</h3>
                                                                                        <h4 class="ltr-text-left">»—‰«„Â ‰ÊÌ” ›—«‰  «‰œ</h4>
                                                                                        <h6 class="ltr-text-left">ÿ—«ÕÌ ò«„ÅÊ‰‰  ReactJs »—«Ì Å·«  œÌ « »Â ’Ê—  RealTime

github.com/mojtabamarashee/Graph.js</h6>
                                                    </div>
                    </div>
                    ...
                    <div class="clearfix">
                        ...
                        <div class="col-lg-7 col-md-7 border-right desc ltr-pull-left">
                            <div class="square"></div>
                                                            <h3 class="ltr-text-left">Ê»</h3>
                                                                                        <h4 class="ltr-text-left">»—‰«„Â ‰ÊÌ”</h4>
                                                                                        <h6 class="ltr-text-left"> ÂÌÂ  ‰—„ «›“«—  Õ  Ê» (fornt end &amp; back end)  »—«Ì „œÌ—Ì  ò«·«Ì «‰»«—° œ«—Ì ç‰œ ”ÿÕ œ” —”Ì Ê «„ò«‰ ê—› ‰ ê“«—‘ »« «” ›«œÂ «“ php Ê javascript Ê jquery  Ê  mysql Ê html</h6>
                                                    </div>
                    </div>
                    ...
                    <div class="clearfix">
                        ...
                        <div class="col-lg-7 col-md-7 border-right desc ltr-pull-left">
                            <div class="square"></div>
                                                            <h3 class="ltr-text-left">›Ì· —Ì‰ê Ê» »— «”«” „Õ Ê«</h3>
                                                                                        <h4 class="ltr-text-left">»—‰«„Â ‰ÊÌ” ÊÌ‰œÊ“</h4>
                                                                                        <h6 class="ltr-text-left">Â„ﬂ«—Ì œ— Å—ÊéÂ &quot;›Ì· —Ì‰ê Ê» »— «”«” „Õ Ê«&quot; „—ﬂ“  ÕﬁÌﬁ«  „Œ«»—«  «Ì—«‰ ( ÂÌÂ ‰—„ù«›“«—Ì ÃÂ  „‘Œ’ ò—œ‰ «Âœ«› œ— Ìò Å«Ìê«Â œ«œÂ »“—ê «“  ’«ÊÌ— »« “»«‰ »—‰«„Âù‰ÊÌ”Ì VISUAL C++ ).</h6>
                                                    </div>
                    </div>
                    ...
                    <div class="clearfix">
                        ...
                        <div class="col-lg-7 col-md-7 border-right desc ltr-pull-left">
                            <div class="square"></div>
                                                            <h3 class="ltr-text-left">Å—œ«“‘  ’ÊÌ—</h3>
                                                                                        <h4 class="ltr-text-left">»—‰«„Â ‰ÊÌ” Å—œ«“‘  ’ÊÌ—</h4>
                                                                                        <h6 class="ltr-text-left">Â„ò«—Ì œ— ê—ÊÂ —»« Ìò Persian Gulf œ«‰‘ê«Â ¬“«œ «’›Â«‰ ( ÂÌÂ ‰—„ «›“«—Ì ÃÂ   ‘ŒÌ’  ÊÅ Ê ê·Â« »« «” ›«œÂ «“ œÊ—»Ì‰  ++VISUAL C ,</h6>
                                                    </div>
                    </div>
                    ...
                    <div class="col-lg-7 col-md-7 border-right height-50 p-0 ltr-pull-left"></div>
                        ...
                        <div class="col-lg-7 col-md-7 border-right desc ltr-pull-left">
                            ...
                            <div class="row di-ltr">
                                            ...
                                            <p>css/css3</p>
                                                                                <div class="progress">
                                            <div class="progress-bar ltr-pull-left" role="progressbar" aria-valuenow="70"
                    ...
                    <div class="col-lg-7 col-md-7 border-right height-50 p-0 ltr-pull-left"></div>
                        ...
                        <div class="col-lg-7 col-md-7 border-right desc p-b-0 ltr-pull-left">
                            <div class="square"></div>
                                ...
                                <h4 class="m-t-0 di-ltr">«‰⁄ÿ«› Å–Ì—Ì</h4>
                        ...
                        <div class="col-lg-7 col-md-7 border-right desc p-b-0 ltr-pull-left">
                            <div class="square"></div>
                                ...
                                <h4 class="m-t-0 di-ltr">Œ·«ﬁÌ  Ê ‰Ê¬Ê—Ì</h4>
                        ...
                        <div class="col-lg-7 col-md-7 border-right desc p-b-0 ltr-pull-left">
                            <div class="square"></div>
                                ...
                                <h4 class="m-t-0 di-ltr">„”∆Ê·Ì  Å–Ì—Ì Ê Å«”ŒêÊÌÌ</h4>
                        ...
                        <div class="col-lg-7 col-md-7 border-right desc p-b-0 ltr-pull-left">
                            <div class="square"></div>
                                ...
                                <h4 class="m-t-0 di-ltr"> Ê”⁄Â ›—œÌ (ŒÊœ  Ê”⁄Â «Ì)</h4>
                    ...
                    <div class="box-resume-light clearfix">
                        ...
                        <div class="col-lg-7 col-md-8 p-0 ltr-pull-left p-b-50">
                            <div class="col-lg-11 col-md-12 ltr-pull-left">
                                                                                                    ...
                                                                                                    <div class="col-lg-4 col-md-4 p-l-0 ltr-pull-left ltr-p-l-15 ltr-p-r-0">
                                        <i class="fa fa-github ltr-pull-left ltr-m-l-0 ltr-m-r-5"></i>
                                        <h4 class="ltr-pull-left">https://github.com/mojtabamarashee</h4>
                                    </div>
...
<path fill="#FFFFFF" d="M563.4,50.3c-12-29.7-31.7-38.5-50.2-36.4c-18.6,2.1-36.3,17.4-44.5,42.5c-3.6,0.6-7,1-10.6,1.6  c11.6-36.3,35.1-54.7,60-57.5c24.8-2.8,51.1,8.1,67.9,50.5C578.5,50.7,571,50.5,563.4,50.3z"></path>
                ...
                <div class="btn-group pull-left">
                    <a style="margin-left: 5px;" href="https://www.linkedin.com/shareArticle?url=https://karboom.io/cv/rqxojk" class="btn btn-share">
                        <i class="fa fa-linkedin"></i>
                    </a>

                    <a href="tg://msg_url?url= https://karboom.io/cv/rqxojk" class="btn btn-share">
                ...
                <button class="btn btn-share pull-left"
                        data-clipboard-target="#foo"
                        id="copy">
                    <i class="fa fa-copy"></i>
                </button>
                <input class="pull-left input-copy" id="foo" value="https://karboom.io/cv/rqxojk">
            </div>
            </div>
</div>
</div>
...
<div class="modal-dialog modal-lg " role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title pull-right" id="exampleModalLongTitle">«—”«· —“Ê„Â «“ ÿ—Ìﬁ «Ì„Ì·</h5>
            <h5 class="modal-title pull-left" id="exampleModalLongTitle">«—”«· «Ì„Ì· «“</h5>
        ...
        <div class="modal-body">
            <form class="form-horizontal">
                <div class="subject-email form-group">
                    <label for="email">⁄‰Ê«‰ «Ì„Ì·:</label>
                    <input type="email" class="form-control" id="email" placeholder="⁄‰Ê«‰ «Ì„Ì·" name="email">
                </div>

                <div class="send-to form-group">
                    <div class="col-lg-9 col-md-9 p-r-0">
                        <label for="email">«—”«· «Ì„Ì·:</label>
                        <input type="email" class="form-control" id="email" placeholder="—“Ê„Â" name="email">
                    </div>
                ...
                <div class="body-email form-group">
                    <textarea name="" id="" cols="30" rows="10" placeholder=" Ê÷ÌÕ« " class="form-control m-b-15"></textarea>
                    ...
                    <div class="col-lg-6 col-md-6 p-l-0">
                        <input type="submit" class="btn btn-kb-g-0 pull-left" value="«—”«·"/>
                    </div>
                </div>
...
<script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="/js/desktop.b619df008ecaa95409e3.js"></script>
<!-- Global site tag (gtag.js) - Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-64083764-1"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-64083764-1');
    </script>
</body>
</html>
